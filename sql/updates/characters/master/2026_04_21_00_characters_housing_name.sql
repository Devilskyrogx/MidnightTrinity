...
-- is already there) to cover any tester whose DB sits between those points. Also a no-op on a
-- fresh database, where `character_housing` is created by 2026_07_09_00_characters.sql.
...
SET @query = IF(@table_exists = 1 AND @col_exists = 0,
